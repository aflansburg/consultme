...
>
	...
	<div class="ml-[4.5rem] truncate text-lg font-bold tracking-wide sm:ml-20 sm:text-xl">{name}</div>
...
<div
	class="min-h-screen px-4 pt-12 sm:pt-10 md:p-8 lg:p-12 {$colorMode === 'dark'
